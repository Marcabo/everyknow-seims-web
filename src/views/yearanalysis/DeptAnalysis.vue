<template>
  <div class="data-visual-school">
    <el-row style="text-align: center; margin-top: 30px">
      ...
      &nbsp;
      <el-select v-model="collegeCode" placeholder="学院" clearable class="filter-item" style="width: 250px; margin-right: 10px"  @change="fetchDept()">
        <el-option v-for="item in collegeList" :key="item.id" :label="item.collegeName" :value="item.collegeCode"/>
      </el-select>
      &nbsp;
      <el-select v-model="deptCode" placeholder="专业" clearable class="filter-item" style="width: 250px; margin-right: 10px">
