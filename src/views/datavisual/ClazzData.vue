<template>
  <div class="data-visual-school">
    <el-row style="text-align: center; margin-top: 30px">
      ...
      <el-select v-model="query.graduationSession" placeholder="毕业届数" clearable class="filter-item" style="width: 250px; margin-right: 10px">
        <el-option v-for="item in graduationSessionList" :key="item" :label="item" :value="item" />
      </el-select>

      <el-select v-model="query.collegeCode" placeholder="学院" clearable class="filter-item" style="width: 250px; margin-right: 10px" @change="fetchDept()">
        <el-option v-for="item in collegeList" :key="item.id" :label="item.collegeName" :value="item.collegeCode" />
      </el-select>

      <el-select v-model="query.deptCode" placeholder="专业" clearable class="filter-item" style="width: 250px; margin-right: 10px" @change="fetchClazz()">
        <el-option v-for="item in deptList" :key="item.id" :label="item.deptName" :value="item.deptCode" />
      </el-select>

      <el-select v-model="query.clazzId" placeholder="班级" clearable class="filter-item" style="width: 250px; margin-right: 10px">
